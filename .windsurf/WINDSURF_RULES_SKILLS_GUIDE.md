...
## Astro Marketing Site Project-Specific Configuration

This guide is customized for the **Astro marketing site** - a TypeScript project using Astro, Cloudflare Pages, and Neon Postgres for an agency marketing website.

### **Available Rules & Skills**

#### **Critical Rules Added**

- **astro-development.md**: Astro component and page development patterns
- **astro-content-collections.md**: Content Collections for blog and structured content
- **cloudflare-deployment.md**: Cloudflare Workers/Pages deployment configuration
- **neon-database.md**: Neon Postgres integration for server-side queries
- **astro-i18n.md**: Internationalization routing and content organization

#### **Essential Skills Available**

- **create-astro-component**: Guide for creating reusable Astro components
- **create-astro-page**: Guide for creating Astro pages with layouts and SEO
- **setup-neon-integration**: Guide for integrating Neon Postgres database
- **configure-cloudflare-deployment**: Guide for deploying to Cloudflare Workers
- **create-blog-content**: Guide for creating blog content with Content Collections
- **implement-i18n-astro**: Guide for implementing multi-language support
- **setup-email-integration**: Guide for integrating email services (Resend/SendGrid)

### **Current Implementation Status (2026)**

- **Frontend**: Astro marketing site with TypeScript and TailwindCSS v4
- **Backend**: Astro API routes for contact form handling
- **Database**: Neon Postgres integration configured
- **Content**: Content Collections for blog posts
- **SEO**: Sitemap, robots.txt, and meta tags configured
- **i18n**: Multi-language routing configured (en, es, fr, de)
- **Deployment**: Cloudflare adapter configured
- **Email**: Contact form integration ready for email service

### **Priority Implementation Areas**

1. **Database Tables** (Neon connection ready, tables need creation)
2. **Email Service** (integration ready, Resend/SendGrid setup needed)
3. **Blog Content** (Content Collections configured, posts needed)
4. **i18n Content** (routing configured, translations needed)
5. **Deployment** (Cloudflare configured, deployment needed)
6. **Testing** (no tests implemented)
7. **Monitoring** (no monitoring implemented)

### **Project Architecture**

- **Framework**: Astro with TypeScript and Vite
